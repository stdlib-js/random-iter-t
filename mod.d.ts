...
/**
* Interface for iterators of pseudorandom numbers drawn from a Student's t distribution.
*/
...
* // ...
*/
declare function iterator( v: number, options?: Options ): Iterator<number>;
